...
import datastore_connect.driver.dataconv as pydc
import datastore_connect.driver.npconv as pync
from datastore_connect.driver.buffer import ResponseBuffer
...
def connect_c_modules():
    ...
    try:
        from datastore_connect.driverc.buffer import ResponseBuffer as CResponseBuffer
        import datastore_connect.driverc.dataconv as cdc
