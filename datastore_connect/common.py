...
from datastore_connect import __version__
...
def build_client_name(client_name: str):
    ...
    if get_setting('send_os_user'):
        try:
            ...
            pass
    full_name = (f'{client_name}{product_name}datastore-connect/{version()}' +
...
_init_common('product_name', (), '')  # Product name used as part of client identification for Datastore query_log
_init_common('readonly', (0, 1), 0)  # Implied "read_only" Datastore settings for versions prior to 19.17
