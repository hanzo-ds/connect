...
from datastore_connect.driver.dataconv import epoch_days_to_date as py_date, pivot as py_pivot
# pylint: disable=no-name-in-module
from datastore_connect.driverc.dataconv import epoch_days_to_date as c_date, pivot as c_pivot
