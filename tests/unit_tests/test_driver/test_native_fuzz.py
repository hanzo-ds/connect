...
from datastore_connect.driver.buffer import ResponseBuffer as PyBuff
from datastore_connect.driverc.buffer import ResponseBuffer as CBuff  # pylint: disable=no-name-in-module
